...
def create_user(connection, user_id, schedule_id, user_type):
    with connection.cursor() as cursor:
...
def edit_schedule_id(connection, user_id, new_schedule_id, new_user_type):
    with connection.cursor() as cursor:
...
def auto_sending(connection, user_id, auto_sending_values):
    with connection.cursor() as cursor:
...
def user_one(connection, user_id):
    with connection.cursor() as cursor:
